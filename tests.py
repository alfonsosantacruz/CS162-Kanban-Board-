...
# Tests
    ...
    def test_registration(self):
        '''
        Test that registration succeeds and a registered user can get to the index page.
        '''
        details = {'username':'Marlin', 'password':'findingnemo', 'repeat':'findingnemo'}
    ...
    def test_right_login(self):
        ...
        '''
        details = {'username':'Marlin',  'password':'findingnemo'}
        req = requests.post('http://127.0.0.1:5000/signin', data = details)
    ...
    def test_faulty_login(self):
        ...
        '''
        details = {'username':'Alfonso', 'password':'test123'}
        req = requests.post('http://127.0.0.1:5000/signin', data = details)
